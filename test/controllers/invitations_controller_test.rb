...
class InvitationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create invitation" do
    assert_difference('Invitation.count') do
      post invitations_url, params: { invitation: { attendee_id: @invitation.attendee_id, event_id: @invitation.event_id } }
    end
  ...
  test "should update invitation" do
    patch invitation_url(@invitation), params: { invitation: { attendee_id: @invitation.attendee_id, event_id: @invitation.event_id } }
